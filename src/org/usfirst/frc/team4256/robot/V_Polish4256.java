...
public class V_Polish4256 {//things that are used regardless of the driver, yet are not specific to a physical object, just copied over some interesting code from last year
